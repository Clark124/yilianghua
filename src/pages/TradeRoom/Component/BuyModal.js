...
export default class BuyModal extends Component {
    ...
    checkInput() {
        ...
        const enable_balance = balance.enable_balance
        const maxBuy = Math.floor(enable_balance / Number(price))
        if (price <= 0) {
            message.error('输入的价格不合规')
            return
        }
        if (count % 100 !== 0) {
            message.error('买入数量必须为100的整数倍')
            return
        }
        if (count <= 0) {
            message.error('输入的买入数量不合规')
            return
        }
        if (count > maxBuy) {
            message.error('买入数量不可超过最大可买数')
            return
        }
        return 1
    }
            ...
            <div className="buy-modal">
                <div className="buy-input-wrapper">
                    <div className="input-item">
                        <span className="title">证券代码：</span>
                    ...
                    <div className="input-item">
                        <span className="title">买入价格：</span>
                    ...
                    <div className="input-item">
                        <span className="title">最大可买：</span>
                        <span className="count">{Math.floor(enable_balance / Number(price))}</span>
                    </div>
                    <div className="input-item">
                        <span className="title">买入数量：</span>
                        <div className="number-operate">
                    ...
                    <div className="input-item">
                        <span className="title">买入金额：</span>
                    ...
                    <div className="reset-buy">
                        ...
                        <span className="btn buy" onClick={this.onSubmit.bind(this)}>买入委托</span>
                    </div>
                ...
                {showBuyModal ? <div className="buy-modal-fixed">
                    <div className="pannel">
                        <div className="title">委托确认 买入</div>
