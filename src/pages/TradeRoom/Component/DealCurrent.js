...
import {dealCurrent} from '../../../serivce'
                    ...
                    {dealList.map((item, index) => {
                            return (
                                <tr className="item" key={index}>
                                    <td>{moment(item.date,'YYYYMMDD').format('MM-DD')+' '+moment(item.business_time,'hhmmss').format('hh:mm:ss')}</td>
